...
# ======================================================
def rao3_fe_capped(obj_func, bias, run_seed):
    ...
    while fes < MAX_FES:
        ...
        for i, x in enumerate(pop):
            ...
            # Rao-3 Mixed Absolute Value Interaction Rule
...
def execute_single_run(f_num, run_id):
    ...
    err_base = rao3_fe_capped(obj_func, bias, seed_base)
...
if __name__ == '__main__':
    ...
    filename = f"IEEE_CEC2022_RAO3_Results_{timestamp}.csv"
    ...
    with open(filename, mode='w', newline='') as file:
        ...
        writer.writerow([
            "Function", 
            "Rao-3_Best", "Rao-3_Worst", "Rao-3_Median", "Rao-3_Mean", "Rao-3_Std",
            "ZO-QRAO_Best", "ZO-QRAO_Worst", "ZO-QRAO_Median", "ZO-QRAO_Mean", "ZO-QRAO_Std",
            "W/T/L", "p-value"
        ])

    print("=========================================================================================================")
    print(" INITIATING IEEE CEC 2022 BENCHMARK: ZO-QRAO vs RAO-3")
    ...
    print("=========================================================================================================")
    print(f"{'Func':<4} | {'Rao-3 (Mean ± Std)':<28} | {'ZO-QRAO (Mean ± Std)':<28} | {'W/T/L':<6} | {'p-val'}")
    print("-" * 105)
    ...
    with open(filename, mode='a', newline='') as file:
        ...
        writer.writerow(["ZO-QRAO vs Rao-3 (Wins/Ties/Losses)", f"{wins} / {ties} / {losses}"])
        ...
        writer.writerow(["2. Rao-3", f"{avg_ranks[0]:.2f}"])

    print("=========================================================================================================")
    print(" FINAL CEC 2022 TALLY: ZO-QRAO vs RAO-3")
    print("=========================================================================================================")
    ...
    print(f" 2. Rao-3                  : {avg_ranks[0]:.2f}")
    print("=========================================================================================================")