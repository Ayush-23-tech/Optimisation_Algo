...
# ======================================================
# ALGORITHM 1: Classical Rao (Rao-1)
# ======================================================
...
# ======================================================
# ALGORITHM 2: ZO-QRAO (Final Variant)
# ======================================================
...
def execute_single_run(f_num, bias):
    ...
    err_base = rao1_fe_capped(obj_func) - bias
...
if __name__ == '__main__':
    ...
    safe_cores = max(1, total_cores - 2) # Thermal Safety Valve
    
    print("=========================================================================================================")
    print(" INITIATING OPTIMIZED EXPERIMENT: ZO-QRAO vs CLASSICAL RAO-1")
    print(f" Hardware: {safe_cores} CPU Cores Active | Single Continuous Pool Architecture")
    ...
    # THE FIX: Open the Executor exactly once, BEFORE the loop
    with concurrent.futures.ProcessPoolExecutor(max_workers=safe_cores) as executor:
        for f_num in range(1, 24):
            ...
            # Feed the pre-warmed workers the 30 runs for the current function
    ...
    print("=========================================================================================================")
    print(" FINAL BENCHMARK TALLY: ZO-QRAO vs CLASSICAL RAO-1")
    print("=========================================================================================================")
    ...
    print(f" 2. Classical Rao-1        : {avg_ranks[0]:.2f}")
    print("=========================================================================================================")