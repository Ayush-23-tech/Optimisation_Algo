...
# ======================================================
def rao2_fe_capped(obj_func, bias, run_seed):
...
def execute_single_run(f_num, run_id):
    ...
    err_base = rao2_fe_capped(obj_func, bias, seed_base)
...
if __name__ == '__main__':
    ...
    filename = f"IEEE_CEC2022_RAO2_Results_{timestamp}.csv"
    ...
    with open(filename, mode='w', newline='') as file:
        ...
        writer.writerow([
            "Function", 
            "Rao-2_Best", "Rao-2_Worst", "Rao-2_Median", "Rao-2_Mean", "Rao-2_Std",
            "ZO-QRAO_Best", "ZO-QRAO_Worst", "ZO-QRAO_Median", "ZO-QRAO_Mean", "ZO-QRAO_Std",
            "W/T/L", "p-value"
        ])

    print("=========================================================================================================")
    print(" INITIATING IEEE CEC 2022 BENCHMARK: ZO-QRAO vs RAO-2")
    ...
    print("=========================================================================================================")
    print(f"{'Func':<4} | {'Rao-2 (Mean ± Std)':<28} | {'ZO-QRAO (Mean ± Std)':<28} | {'W/T/L':<6} | {'p-val'}")
    print("-" * 105)
    ...
    with open(filename, mode='a', newline='') as file:
        ...
        writer.writerow(["ZO-QRAO vs Rao-2 (Wins/Ties/Losses)", f"{wins} / {ties} / {losses}"])
        ...
        writer.writerow(["2. Rao-2", f"{avg_ranks[0]:.2f}"])

    print("=========================================================================================================")
    print(" FINAL CEC 2022 TALLY: ZO-QRAO vs RAO-2")
    print("=========================================================================================================")
    ...
    print(f" 2. Rao-2                  : {avg_ranks[0]:.2f}")
    print("=========================================================================================================")